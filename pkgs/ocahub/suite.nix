...
#
# Copied verbatim from the pyterm tree (pymux/nix/suite.nix there), whose
# checks run on it. Reaching it in place would mean threading pyterm's
# submodule resolver for one file; a change worth taking upstream lands
# here first. If this ever drifts from the original in a way that
# matters, take the file, not a fork of the idea.
#
